...
public class SimpleTweaksCompatibilityModule(string targetModuleName, string? allowedVersion = null) : CompatibilityModule(allowedVersion) {
    ...
    private bool IsSimpleTweaksLoaded()
