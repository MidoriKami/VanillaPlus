...
public class ClassJobListItemNode : GenericListItemNode<ClassJob> {
    ...
    protected override string GetLabelText(ClassJob data)
        => throw new System.NotImplementedException();

    protected override string GetSubLabelText(ClassJob data)
        => throw new System.NotImplementedException();

    protected override uint? GetId(ClassJob data)
        => throw new System.NotImplementedException();
}
