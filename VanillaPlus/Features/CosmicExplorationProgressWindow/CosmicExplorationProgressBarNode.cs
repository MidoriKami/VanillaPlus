...
public class CosmicExplorationProgressBarNode : SimpleComponentNode {
    ...
    public CosmicExplorationProgressBarNode() {
        ...
        BackgroundImageNode.AddNodeFlags(NodeFlags.AnchorLeft, NodeFlags.AnchorRight, NodeFlags.AnchorTop,
        ...
        ProgressNode.AddNodeFlags(NodeFlags.AnchorLeft, NodeFlags.AnchorRight, NodeFlags.AnchorTop,
            NodeFlags.AnchorBottom);
        ...
        BorderImageNode.AddNodeFlags(NodeFlags.AnchorLeft, NodeFlags.AnchorRight, NodeFlags.AnchorTop,
            NodeFlags.AnchorBottom);
