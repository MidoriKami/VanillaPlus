...
public sealed class DatasetNode : ResNode {
    ...
    public DatasetNode(float contentWidth) {
        Size = new Vector2(contentWidth, 26.0f);
        ...
        IconNode.AddNodeFlags(NodeFlags.AnchorLeft, NodeFlags.AnchorTop, NodeFlags.AnchorBottom);
        ...
        ProgressBarNode.AddNodeFlags(NodeFlags.AnchorRight, NodeFlags.AnchorTop, NodeFlags.AnchorBottom,
        ...
        MaxedProgressBarNode.AddNodeFlags(NodeFlags.AnchorRight, NodeFlags.AnchorTop, NodeFlags.AnchorBottom,
            NodeFlags.AnchorLeft);
        ...
        MaxLabelNode.AddNodeFlags(NodeFlags.AnchorRight, NodeFlags.AnchorTop, NodeFlags.AnchorBottom);
    ...
    public void UpdateData(CosmicExplorationProgressWindow.Progress p) {
        ...
        MaxedProgressBarNode.Progress = ((float)p.Current - p.Needed) / ((float)p.Max - p.Needed);
