...
public class PrimaryTargetAltCastbarController {
    ...
    private const string StylePath = "TargetCastBarCountdown.PrimaryTargetAlt.style.json";

    private readonly AddonController addonController;

    public unsafe PrimaryTargetAltCastbarController(TargetCastBarCountdownConfig config) {
        this.config = config;
