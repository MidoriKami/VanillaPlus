...
public class LargeInventoryController : IDisposable {

    private readonly Dictionary<string, ControllerNodeset> addonControllers = [];

    public unsafe LargeInventoryController() {
        foreach (var addonName in (List<string>)[ "InventoryGrid0", "InventoryGrid1" ]) {
