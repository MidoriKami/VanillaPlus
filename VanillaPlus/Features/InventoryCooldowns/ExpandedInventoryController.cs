...
public class ExpandedInventoryController : IDisposable {

    private readonly Dictionary<string, ControllerNodeset> addonControllers = [];

    public unsafe ExpandedInventoryController() {
        foreach (var addonName in (List<string>)[ "InventoryGrid0E", "InventoryGrid1E", "InventoryGrid2E", "InventoryGrid3E"]) {
